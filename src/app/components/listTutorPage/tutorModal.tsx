                    ...
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="container mx-auto flex px-2 py-8 items-center justify-center flex-col">
                          <img className="lg:w-3/6 md:w-3/6 mb-10 object-fill object-center rounded" style={{ width: "350px", height: "450px" }} alt="hero" src={tutor.avatar} />
                          <div className="text-left lg:w-3/4 w-full">
                            <div className="text-align px-2 sm:px-0 flex items-center justify-center">
                              <h3 className={classes.typographyIntro}>Tutor Detail Information</h3>
                            </div>
                            ...
                            <div className="mt-6 border-t border-gray-100">
                              <dl className="divide-y divide-gray-100">
                                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                  ...
                                  <dd className={`${classes.typography} mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0`}>{tutor.firstName} {tutor.lastName}</dd>
                                </div>
                                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                  <dt className={classes.typographyTitle}>Email</dt>
                                  <dd className={`${classes.typography} mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0`}>{tutor.email}</dd>
                                </div>
                                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                  <dt className={classes.typographyTitle}>Phone number </dt>
                                  <dd className={`${classes.typography} mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0`}>{tutor.phoneNumber}</dd>
                                </div>
                                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                  <dt className={classes.typographyTitle}>Role</dt>
                                  <dd className={`${classes.typography} mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0`}>{tutor.userRole.roleName}</dd>
                                </div>
                                <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
