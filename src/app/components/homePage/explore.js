      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-20 mx-auto">
          <div class="flex flex-col text-center w-full mb-20">
            ...
            <p class={`${classes.p} lg:w-2/3 mx-auto leading-relaxed text-base`}>
              Discover top-notch study resources spanning a wide range of subjects to propel you toward academic achievement.
            </p>
          </div>
          <div class="flex flex-wrap -m-2">
            <div class="lg:w-1/3 sm:w-1/2 p-6">
              <div class={`${classes.box} flex relative`}>
                <div class="flex  md:flex-row flex-col items-center px-12 py-10 relative z-10 w-full">
                  ...
                  <h3 class={classes.item}>Software Engineering</h3>
                </div>
              </div>
            </div>
            <div class="lg:w-1/3 sm:w-1/2 p-6">
              <div class={`${classes.box} flex relative`}>
                <div class="flex  md:flex-row flex-col items-center px-12 py-10 relative z-10 w-full">
                  ...
                  <h3 class={classes.item}>Artificial Intelligence</h3>
                </div>
              </div>
            </div>
            <div class="lg:w-1/3 sm:w-1/2 p-6">
              <div class={`${classes.box} flex relative`}>
                <div class="flex  md:flex-row flex-col items-center px-12 py-10 relative z-10 w-full">
                  ...
                  <h3 class={classes.item}>Digital Art Design</h3>
                </div>
              </div>
            </div>
            <div class="lg:w-1/3 sm:w-1/2 p-6">
              <div class={`${classes.box} flex relative`}>
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                  ...
                  <h3 class={classes.item}>Digital Marketing</h3>
                </div>
              </div>
            </div>
            <div class="lg:w-1/3 sm:w-1/2 p-6">
              <div class={`${classes.box} flex relative`}>
                <div class="flex  md:flex-row flex-col items-center px-10 py-10 relative z-10 w-full">
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="96" height="96" viewBox="0 0 96 96" fill="none">
                      <g clip-path="url(#clip0_628_100)">
                  ...
                  <h3 class={classes.item}>International Business</h3>
                </div>
              </div>
            </div>
            <div class="lg:w-1/3 sm:w-1/2 p-6">
              <div class={`${classes.box} flex relative`}>
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                  ...
                  <h3 class={classes.item}>Multimedia comunicate</h3>
                </div>
              </div>
            </div>
          </div>
          <button class={`${classes.button} flex mx-auto mt-16 text-white py-2 px-8`}>
