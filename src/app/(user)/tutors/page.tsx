            ...
            <>
                <div style={{ background: "#fff" }}>
                    ...
                    <section className=" body-font ">
                        ...
                        <div className={`${classes.customBorder} mt-12 py-2 flex flex-wrap md:flex-nowrap custom-container`}>
                            <div className="container px-6 py-0 mx-20 flex items-center md:flex-row flex-col">
                                ...
                                <div className="flex md:ml-auto md:mr-0 mx-auto items-end flex-shrink-0 space-x-6">
                                    ...
                                    <span className="ml-24 flex items-start flex-col leading-none">
                        ...
                        {/* Requirement List */}
                        <div className=" px-2 py-12 mx-24">
                            <div className="flex flex-wrap -m-2">
                                <div className={`${classes.card} p-0 mb-16 w-full`}>
